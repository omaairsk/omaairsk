...
const iamfardinsk = {
  ...
  focus     : ["Secure P2P Systems", "WebRTC", "Encrypted Comms", "AI-Powered Apps"],
  current   : "[ NEURAL_LINK ] — Next-gen P2P communication platform",
  stack     : ["React", "Node.js", "Python", "PostgreSQL", "WebRTC", "AES-256-GCM"],
  also      : ["Medical Diagnostic Centre", "Android App Publisher (Google Play)"],
  social    : {
    instagram : "instagram.com/iamfardinsk",
    facebook  : "facebook.com/iamfardinsk00",
  },
  philosophy: "Build things that are impossible to ignore.",
};
```
...
|---------|-------------|-------|
| 🔐 **[fardomaxp2p](https://github.com/omaairsk/fardomaxp2p)** | Encrypted P2P file sharing — AES-256-GCM + WebRTC + TURN relay | HTML · JS · WebCrypto |
| 🌐 **[NEURAL-LINK-P2P-SYSTEM](https://github.com/omaairsk/NEURAL-LINK-P2P-SYSTEM)** | Next-gen peer-to-peer communication platform | HTML · WebRTC · Node.js |
| 🚀 **[NEURAL-LINK-Portal](https://github.com/omaairsk/NEURAL-LINK-Portal)** | Portal & gateway for the NEURAL_LINK ecosystem | HTML · CSS · JS |
| 🖤 **[Vantablack](https://github.com/omaairsk/Vantablack)** | Private search engine with Vanta.js 3D animated UI | HTML · JS · Vanta |
| 🏥 **[mdcbooking](https://github.com/omaairsk/mdcbooking)** | Medical Diagnostic Centre appointment booking system | HTML · CSS · JS |
| 💻 **[nytrixworkstation](https://github.com/omaairsk/nytrixworkstation)** | Developer workstation dashboard & productivity hub | HTML · CSS · JS |
...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/iamfardinsk/)
[![Facebook](https://img.shields.io/badge/Facebook-1877F2?style=for-the-badge&logo=facebook&logoColor=white)](https://www.facebook.com/iamfardinsk00/)
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/omaairsk)
[![Google Play](https://img.shields.io/badge/Google_Play-414141?style=for-the-badge&logo=google-play&logoColor=white)](https://play.google.com/store/apps/dev?id=6431562943572296852&pli=1)
